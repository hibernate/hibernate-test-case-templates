 ...
 * submit it as a PR!
 */
public class ORMUnitTestCaseHhh16360H2 extends BaseCoreFunctionalTestCase {
    ...
    protected void configure(Configuration configuration) {
        ...
        configuration.setProperty(AvailableSettings.URL, "jdbc:h2:mem:db1;DB_CLOSE_DELAY=-1");
